...
While the MIE and MIC datasets include some innovations in the way events are coded, and what information is either included or excluded from the data, both datasets are premised on the foundational ideas behind the concept of MIDs crystallized by @jones1996militarized, along with updates made by subsequent iterations of the COW MID project.
...
Before we get to that step though, I think it's a good idea to just look at the information on offer in the dataset. I've copied below the relevant details from the [MIE codebook](https://internationalconflict.ua.edu/wp-content/uploads/2023/07/MIEcodebook.pdf). Each bullet point tells you the name of a column in the dataset and what it represents.
...
### Making Some Graphs of Data Summaries
...
I'm not going to get too bogged down in the details of data visualization here. But if you want to know the whole range of things you can do in terms of data visualization, you can check out [some brief lecture notes](https://milesdwilliams15.quarto.pub/data-and-research-design/02_look_at_data.html) I've written for my 200-level class on research design, or [more detailed notes](https://milesdwilliams15.quarto.pub/dpr-101-data-visualization-for-political-research/) I've written for a 100-level class I teach on data visualization.
