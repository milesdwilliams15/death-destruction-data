...
source(
  here::here("helpers", "peacesciencer_extras.R")
)
```
...
I have to confess that I don't really know, but this slight, seemingly innocuous tweak that gave me statistically significant results that contradict the first set of findings, should raise alarm bells. And this is the point I wanted to make. My goal in this exercise wasn't to test BoP and PT head-to-head and declare a victor; it was to demonstrate that it's possible to analyze the data in such a way that supports either theory.
